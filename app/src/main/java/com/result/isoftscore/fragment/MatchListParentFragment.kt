...
class MatchListParentFragment: Fragment() {

    private lateinit var rootView: View
    companion object {
        fun newInstance(): MatchListParentFragment {
            return MatchListParentFragment()
        }
    }
    ...
    private fun setupViewPager() {
        ...
        pagerAdapter.addFragment(MatchListFragment.newInstance(MatchListType.NEXT_MATCH), getString(R.string.next_match))
        pagerAdapter.addFragment(MatchListFragment.newInstance(MatchListType.PREV_MATCH), getString(R.string.prev_match))
        pagerAdapter.addFragment(MatchListFragment.newInstance(MatchListType.FAVORITES_MATCH), getString(R.string.favorite))
